...
export default function Play() {
  ...
  const toggleFavorite = () => {
    ...
    const gameObj: Game = {
      slug,
      title: gameTitle,
      image: `/api/proxy-images/files/games/other/${slug}/${slug}.jpg`, // generic fallback image path
      category: "favorites",
    };
    ...
    <>
      ...
      <header className="header">
        ...
        <div className="header-actions">
          <div className="favorites-link" onClick={() => router.push("/")}>
        ...
        <div className="sidebar-controls">
          ...
          <div className="sidebar-game-meta">
            ...
            <div className="meta-row">
              ...
              <span className="meta-value" style={{ color: "var(--accent-cyan)" }}>100% Proxied</span>
            </div>
            <div className="meta-row">
          ...
          <div className="action-buttons">
            ...
            <button 
              ...
              id="favorite-btn-id"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill={isFavorite ? "var(--accent-pink)" : "none"} stroke={isFavorite ? "var(--accent-pink)" : "currentColor"} strokeWidth="2">
